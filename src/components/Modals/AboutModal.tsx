...
const RELEASES: readonly { version: string; date: string; changes: string[] }[] = [
  {
    ...
    changes: [
      ...
      'รองรับทุกอัตราส่วนภาพ ไม่บิด และสลับดูแบบธรรมดาได้ จึงใช้ดูรูป/วิดีโอหน้างานทั่วไปได้ด้วย',
      'ไฟล์ .insp/.insv จาก Insta360 ต้องส่งออกเป็น JPG/MP4 ก่อน ส่วน Ricoh Theta ใช้ได้ทันที',
      'เพิ่มปุ่มลบไฟล์ทั้งสามโหมด เอาไฟล์ออกได้โดยไม่ต้องเปิดไฟล์ใหม่มาทับ',
      'แถบเครื่องมือและแถบสถานะซ่อนของ 2D เมื่ออยู่โหมด 3D หรือ 360',
    ],
  },
  {
    version: '1.7.0',
